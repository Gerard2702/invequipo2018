...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6 text-right">
            <a href="{{route('equipments.edit',$equipment[0]->id)}}" class="btn btn-success btn-sm"><i class="fa fa-cog"> Editar</i></a>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row ">
        <div class="col-md-12">
            ...
            <h5><strong>Caracteristicas del Procesador</strong> <a href="#" class="btn btn-primary btn-sm" id="btncaracteristicas" data-content="{{$equipment[0]->id}}"><i class="fa fa-plus"></i></a></h5>
            ...
            <div class="col-md-12"><div class="separate"></div></div>
            <h5><strong>Software</strong> <a href="#" class="btn btn-primary btn-sm" id="btnsoftware" data-content="{{$equipment[0]->id}}"><i class="fa fa-plus"></i></a></h5>
            ...
            <div class="col-md-12"><div class="separate"></div></div>
            <h5><strong>Identificacion de RED</strong> <a href="#" class="btn btn-primary btn-sm" id="btnred" data-content="{{$equipment[0]->id}}"><i class="fa fa-plus"></i></a></h5>
